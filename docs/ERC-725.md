...
_Returns:_ `bytes[]` , array of data at multiple keys.
#### setData
...
ERC725Account section is now moved to a new standard [LSP0](https://github.com/lukso-network/LIPs/blob/master/LSPs/LSP-0-ERC725Account.md).
