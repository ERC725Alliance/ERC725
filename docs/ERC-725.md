...
Smart contracts implementing the ERC725X standard MUST implement all of the functions listed below:
...
- `target` SHOULD be address(0) in case of contract creation (operation types 1 and 2).
...
Sets data as bytes in the storage for a single key. 
