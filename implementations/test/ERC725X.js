...
contract("ERC725X", accounts => {
    ...
    context("Testing contract functions", async () => {
      ...
      let account = {};
      const largebytes = "";
      ...
      it("Allows owner to execute create", async () => {
        ...
        let receipt = await account.execute(OPERATION_CREATE, dest, '0', largebytes, {
          from: owner
        });
      ...
      it("Should return contract address when using create1",async()=>{
        ...
        let receipt = await account.execute.call(OPERATION_CREATE, dest, '0', largebytes, {
          from: owner
        });
      ...
      it("Should return contract address when using create2",async()=>{
        ...
        // deploy with added 32 bytes salt
        let receipt = await account.execute.call(OPERATION_CREATE2, owner, '0', data,
            {
              from: owner
            }
        );
      ...
      context("Revert on failed low level call and return bytes",async()=>{
        ...
        it("Should return some array of strings (decoded)",async()=>{
          ...
          result = await account.execute.call(OPERATION_CALL,returnTest.address,"0x0",abi,{
            from: owner
          });
